...
class H4compareHC {
    ...
    fun hasStruct() {
        ...
        readData(testData + "devcdm/hdf4/17766010.hdf")
 ...
 //           "Sea_Ice_Motion_Vectors_-_17766010")
    ...
    @Test
    fun swath() {
        compareH4header(testData + "netchdf/hdf4/jeffmc/swath.hdf")
    }
    ...
    @Test
    fun problemHeader() {
        val filename = testData + "netchdf/hdf4/AST_L1B_00307182004110047_08122004112525.hdf"
