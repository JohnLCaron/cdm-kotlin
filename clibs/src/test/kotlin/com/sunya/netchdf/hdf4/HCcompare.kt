...
class HCcompare {
    ...
    fun testRasterData() {
        ...
        // compareData(filename, "Raster_Image_#0")
    }
    ...
    @Test
    fun problem() {
        readHCheader(testData + "hdf4/NOAA.CRW.OAPS.25km.GCR.200402.hdf")
        readH4header(testData + "hdf4/NOAA.CRW.OAPS.25km.GCR.200402.hdf")
        readH4data(testData + "hdf4/NOAA.CRW.OAPS.25km.GCR.200402.hdf")
        compareH4header(testData + "hdf4/NOAA.CRW.OAPS.25km.GCR.200402.hdf")
        readH4CheckUnused(testData + "hdf4/NOAA.CRW.OAPS.25km.GCR.200402.hdf")
    }
