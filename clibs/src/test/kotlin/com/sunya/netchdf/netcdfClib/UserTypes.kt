...
internal fun readVlenDataList(nelems : Long, basetype : Datatype, vlen_p : MemorySegment) : List<*> {
    ...
    for (elem in 0 until nelems) {
        val count = com.sunya.netchdf.netcdfClib.ffm.nc_vlen_t.getLength(vlen_p, elem)
        val address: MemoryAddress = com.sunya.netchdf.netcdfClib.ffm.nc_vlen_t.getAddress(vlen_p, elem)
