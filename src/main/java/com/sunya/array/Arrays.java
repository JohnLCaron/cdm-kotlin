...
public class Arrays {
  ...
  /**
   * Compare values which must be equal to within {@link NumericCompare#defaultMaxRelativeDiffDouble}.
   */
  ...
  /**
   * Compare values which must be equal to within {@link NumericCompare#defaultMaxRelativeDiffFloat}.
   */
