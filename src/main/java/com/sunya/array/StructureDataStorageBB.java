...
import com.sunya.array.StructureMembers.Member;
    ...
    switch (dataType) {
      ...
      case STRUCTURE: {
        ...
        for (int nrow = 0; nrow < length; nrow++) {
          ...
          for (Member nmember : nestedMembers) {
    ...
    public Array<?> getMemberData(Member m) {
      ...
      switch (dataType) {
        ...
        case BYTE: {
          ...
          return new ArrayByte(dataType, m.getShape(), new ArrayByte.StorageS(array));
        }
        ...
        case INT: {
          ...
          return new ArrayInteger(dataType, m.getShape(), new ArrayInteger.StorageS(array));
        }
        ...
        case LONG: {
          ...
          return new ArrayLong(dataType, m.getShape(), new ArrayLong.StorageS(array));
        }
        ...
        case SHORT: {
          ...
          return new ArrayShort(dataType, m.getShape(), new ArrayShort.StorageS(array));
        }
        ...
        case STRING: {
          ...
          return new ArrayString(m.getShape(), new ArrayString.StorageS(array));
        }
